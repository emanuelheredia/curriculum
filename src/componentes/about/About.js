		...
		<div className="about-container">
			<div className="about-desc">
				...
				<p className="text-efecto-maquina-escribir">
					Passionate and continuously growing Front End Developer with strong skills in web development. Experienced in collaboration and teamwork, I enjoy providing innovative solutions. I am seeking opportunities to further learn and enhance my technical abilities. Committed to excellence, I focus on building attractive and functional interfaces. Ready to contribute my experience and enthusiasm to challenging projects. Skills: React JS | Python | Redux | JavaScript | HTML | CSS | NodeJS | Typescript | Selenium | Scrapy / Git | GitHub.
