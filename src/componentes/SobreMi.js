    ...
    return (
        <div>
            ...
            <div className='text-center container mt-2 text-center p-5 animate__animated animate__bounceInLeft'>
                ...
                <p className='m-5 px-5 fs-5 shadow p-3 mb-5 bg-body rounded'>Soy desarrollador Frontend con gran pasión por resolver problemas utilizando nuevas tecnologías, y con gran entusiasmo en aprender continuamente. Me encantaría formar parte de una empresa que me permita
